...
1.	Mark your cross section with rebar stakes beyond the bankfull width and extend 10 or 20 meeters into the flood-prone area (if possible), and tie a string between the stakes. Work with your team to make sure your string is level. Attach a field tape parallel to the level string and tie tightly to rebar. 
...
1.	Estimate a value for Manning's "n" for the area immediately around your cross section.  Guidance for this should come from the picture books provided during lab.
...
# Assessment: Calculations using pre-collected data
...
Use the data you collected in the field work section to answer the following questions (60 pts)

**1.	Cross Sectional and Longitudinal Data**
...
a.	Include your Manning’s n in the table outlined below.

b.	Using the cross section data that you collected, use Manning’s Equation to estimate the following and include results in the table outlined below 
...
c.	Rearrange and solve Manning's equation for n using the discharge you measured with the Velocity-Area module (i.e., what value would Manning's n have to be for the calculated discharge to equal the measured discharge?) and include in the table outlined below.
...
**5.	Relative Bed Stability (RBS): Calculate the RBS and include in the table outlined below**
