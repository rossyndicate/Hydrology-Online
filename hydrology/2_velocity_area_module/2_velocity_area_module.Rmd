...
<iframe width="560" height="315" src="https://youtu.be/0ohVXAGI9lk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

## Reading

https://www.dropbox.com/s/lnsrr32039k02p2/Dingman_2002_Appendix_F.pdf?dl=0

# Lecture

<iframe width="560" height="315" src="https://youtu.be/hgPoorCAAGg" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
## 1.4: Setting the top-setting wading rod
...
See supplemental video on setting wading rod here: 
...
# Assessment 
Calculations using pre-collected data provided [here](https://www.dropbox.com/s/pp7spwyk9maa4ul/Velo_Area_Assessment.xlsx?dl=0 ) 

### 3.1: Velocity Area Method (Continued)

Use the provided field data to answer the following questions. Note highlighted green rows and columns are data that have been collected in the field. Yellow highlighted rows and columns are what you will be filling in following the directions below:

**1.	Use the provided cross-section and float velocity data to calculate the discharge for this cross section**

a.	Multiply your float velocities by 0.85 and calculate the discharge.

b.	What does multiplying by 0.85 achieve?

**2.	Use provided cross-section data to create a table with the calculated Area ($m^{2}$), Q($m^{3}/s$), and % flow in each sub-section**

a.	What is the mean velocity?

b.	What is the total area?

c.	What is the discharge at this cross-section?

d.	Provide a handwritten or typed sample calculation for each parameter (area, Q, and % flow). Include this as a scanned attachment or photo.

e.	Indicate the number of sub-sections that had greater than 5% of the total flow.

f.	Does this meet USGS Standards? If not, how could you collect this data differently to ensure that it meets the USGS standards?
...
**Question #1: Velocity-Area Discharge** 

a.	Provide a table (similar to the table below) with the following information for the 3 velocity area cross-sectional measurements of streamflow that you collected in the field.
	+ Measured discharge.
	+ The highest percent flow in a sub-section of the cross-section.

![](images/table_example.JPG)

b.	Discuss if your measurements meet the USGS Standards? Why or why not?

c.	If there is a USGS gage nearby your stream site, lookup the USGS gage discharge at the time of your measurement. How does the gage discharge compare to your measured discharge? If there is a large difference between these values, comment on what may cause these differences.

d.	What are the three greatest sources of error in the discharge values derived from your velocity-area measurements? 

e.	If you took measurements equally spaced throughout the reach, would you expect the discharge to be higher or lower than if you took more measurements in the thalweg of the stream? Why?

**Question #2: Velocity Measurements**

a.	Create a graph of the vertical velocity profile with the velocities you recorded at different depths.

b.	Make a table comparing the thalweg velocities measured using the following techniques:
  ...
  +	Float velocity times 0.85.
  
c.	Comment on the comparability of measures obtained from each of the four techniques used to measure velocity. Do you get reasonable velocity values from low-cost approaches such as float method? Conversely, do you obtain much better data from the expensive current meter? Provide an example of a situation where you would recommend: float, and current meter.

**Question #3**

You have a thalweg profile; we use 0.6 depth to approximate the average vertical velocity when making velocity area Q measurements. Use your data to determine if this assumption is valid for your measurements.
